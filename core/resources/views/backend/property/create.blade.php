                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{ route('admin.properties.store') }}" method="POST" class="needs-validation"
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-4 col-4">
                                                ...
                                                <input type="text" class="form-control" name="name"
                                                    value="{{ old('name') }}" placeholder="enter property name"
                                                    required="">
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <input type="text" class="form-control" name="launch_date"
                                                    value="{{ old('launch-date') }}" placeholder="enter launch-date">
                                            </div>

                                            <div class="form-group col-md-4">
                                                <label for="">{{ __('Land-area') }}</label>
                                                <input type="text" class="form-control" name="land_area"
                                                    value="{{ old('land-area') }}" placeholder="enter land-area"
                                                    required="">
                                                <div class="invalid-feedback">
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <input type="text" class="form-control" name="room"
                                                    value="{{ old('room') }}" placeholder="enter room" required="">
                                                <div class="invalid-feedback">
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <input type="text" class="form-control" name="bedroom"
                                                    value="{{ old('bedroom') }}" placeholder="enter bedroom"
                                                    required="">
                                                <div class="invalid-feedback">
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <input type="text" class="form-control" name="bathroom"
                                                    value="{{ old('bathroom') }}" placeholder="enter bathroom"
                                                    required="">
                                                <div class="invalid-feedback">
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <input type="text" class="form-control" name="garages"
                                                    value="{{ old('garages') }}" placeholder="enter bathroom">
                                            </div>
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <input type="text" class="form-control" name="map_link"
                                                    value="{{ old('map_link') }}" placeholder="enter Property-map-link">
                                            </div>
                                            ...
                                            <div class="form-group col-md-12 col-12">
                                                <label>{{ __('gallery Images') }} (750 x 500 px) (use 5 image for perfect fit)</label>
                                            ...
                                            <div class="form-group col-md-12">
                                                <button type="submit"
                                                    class="btn btn-primary">{{ __('Create Property') }}
                                                </button>
                                            </div>
