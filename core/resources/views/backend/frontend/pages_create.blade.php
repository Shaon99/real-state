                                ...
                                <form action="" method="POST" class="col-md-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <p class="text-capitalize">{{ __('For Nav Bar Select The Section You Want to add your page and green color for selected') }}</p>
                    ...
                    $('.selectable').each(function(index) {
                        ...
                        $(this).on('click', function() {
                            ...
                            if ($(this).attr('data-clicked') == 'off') {
                                ...
                                $(this).children().removeClass('bg-gradient-success').addClass('bg-gradient-primary');
                            ...
                            $(this).children().removeClass('bg-gradient-primary').addClass('bg-gradient-success');
