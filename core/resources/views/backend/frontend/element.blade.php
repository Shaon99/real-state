            ...
            <section class="section">
                <div class="section-header">
                    ...
                    <div class="section-header-breadcrumb">
                        <div class="breadcrumb-item active"><a href="{{ route('admin.frontend.section.manage', request()->name) }}">{{ __('Manage '.@$pageTitle.' Section') }}</a>
                        </div>
                                      ...
                                      @if ($sec == 'text')
                                        ...
                                        <div class="col-md-12">                                        
                                            <div class="form-group w-25">
                                                <label class="col-form-label">{{ __(frontendFormatter($key)) }} ({{ @$section['size'] }})</label>
