                                            ...
                                            @foreach ($section['content'] as $key => $sec)
                                                ...
                                                @elseif($sec == 'file')
                                                    <div class="form-group col-md-6 mb-3">
                                                        <label
                                                            class="col-form-label">{{ __(frontendFormatter($key)) }} ({{ @$section['content']['size'] }})</label>
                                                    ...
                                                    @elseif($sec == 'another_image')
                                                    <div class="form-group col-md-6 mb-3">
                                                        <label
                                                            class="col-form-label">{{ __(frontendFormatter($key)) }} ({{ @$section['content']['site_image_size'] }})</label>

                                                            <div id="image-preview-another" class="image-preview"
                                                            style="background-image:url({{ getFile(request()->name, @$content->data->$key) }});">
                                                            <label for="image-upload-another"
                                                                id="image-label-another">{{ __('Choose File') }}</label>
                                                            <input type="file" name="{{ $key }}"
                                                                id="image-upload-another" />
                                                        </div>
                                        ...
                                        <table class="table table-striped">
                                            ...
                                            @forelse($elements as $element)
                                                <tr class="text-center">
                                                    ...
                                                    <td><img src="{{ getFile(request()->name, $element->data->$key) }}"
                                                        alt="" class="image-rounded p-2 image-fluid" width="40%"></td>
...
@push('script')
    <script>
        $(function() {
            ...
            $.uploadPreview({
                input_field: "#image-upload-another",
                preview_box: "#image-preview-another",
                label_field: "#image-label-another",
                label_default: "{{ __('Choose File') }}",
                label_selected: "{{ __('Upload File') }}",
                no_label: false,
                success_callback: null
