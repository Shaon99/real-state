...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('asset/frontend/css/error.css') }}" />
...
<body>
  ...
  s25.3-11.3,25.3-25.3C125.3,29,115.9,18.5,103.8,16.7z" />
        ...
        <div class="message">
            {{ __('Oooops! Internal Server Error. That is, something went terribly wrong Don"t worry, we"ve been reported about that.') }}
            <br>
            {{ __('In the meantime, you can help us catch some nasty bugs. We got you the deadliest of all weapons!') }}
        </div>
        <div class="mt-5">
