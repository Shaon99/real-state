...
<section id="hero-area" class="parallax-searchs home15 thome-6 thome-1 overlay " data-stellar-background-ratio="0.5"
    style=" background: -webkit-gradient(linear, left top, left bottom, from(rgba(0, 0, 0, 0.5)), to(rgba(0, 0, 0, 0.5))), url(<?php echo e(getFile('banner', @$content->data->image)); ?>);
                ...
                <div class="col-12">
                    <div class="hero-inner">
                        ...
                        <div class="welcome-text">
                            <h1 class="h1"><?php echo e(@$content->data->title); ?>

                                <br class="d-md-none">
                                <span class="typed border-bottom"></span>
                            </h1>
                            <p class="mt-4"><?php echo e(@$content->data->short_description); ?></p>
                        </div>
                        <!--/ End Welcome Text -->
                        <!-- Search Form -->
                        <div class="col-12">
...
<?php $__env->startPush('script'); ?>
    <script src="<?php echo e(asset('asset/frontend/js/typed.min.js')); ?>"></script>
    ...
    <script>
        ...
        $(document).on('submit', '#mainsearchItem', function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: "<?php echo e(route('mainsearch')); ?>",
                data: {
                    name: name,
...
<!-- END HEADER SEARCH -->
<?php /**PATH C:\xampp\htdocs\asset\core\resources\views/frontend/sections/banner.blade.php ENDPATH**/ ?>