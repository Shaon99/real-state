...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('asset/frontend/css/error.css')); ?>" />
...
<body>
    <div id="container">
        ...
        <svg viewBox="0 0 200 82.7" style="enable-background:new 0 0 200 82.7;" xml:space="preserve">

            <g id="Calque_1">
                <text id="XMLID_3_" transform="matrix(1.2187 0 0 1 13 75.6393)" class="st0 st1">5</text>
                <text id="XMLID_4_" transform="matrix(1.2187 0 0 1 133.0003 73.6393)" class="st0 st1">5</text>
            </g>
            <g id="Calque_2">
                <g>
                    <path id="XMLID_11_"
  ...
  s25.3-11.3,25.3-25.3C125.3,29,115.9,18.5,103.8,16.7z" />
        ...
        <div class="message">
            <?php echo e(__('Oooops! Internal Server Error. That is, something went terribly wrong Don"t worry, we"ve been reported about that.')); ?>

            <br>
            <?php echo e(__('In the meantime, you can help us catch some nasty bugs. We got you the deadliest of all weapons!')); ?>
...
<?php /**PATH C:\xampp\htdocs\asset\core\resources\views/errors/500.blade.php ENDPATH**/ ?>