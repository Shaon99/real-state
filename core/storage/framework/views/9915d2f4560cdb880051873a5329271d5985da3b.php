            ...
            <div class="project-single">
                <div class="project-inner project-head">
                    <div class="project-bottom">
                        <h4><a href="<?php echo e(route('property.details', Str::slug($item->slug))); ?>">View
                                Property</a><span class="category"><?php echo e($item->name); ?></span></h4>
                    </div>
                    <div class="homes">
                        <!-- homes img -->
                        <a href="<?php echo e(route('property.details', Str::slug($item->slug))); ?>" class="homes-img">
                            ...
                            <img src="<?php echo e(getFile('properties', $item->picture)); ?>" alt="img" style="height:209px"
...
<?php /**PATH C:\xampp\htdocs\asset\core\resources\views/frontend/pages/ajaxsearchitem.blade.php ENDPATH**/ ?>